...
namespace Sidus\SidusBundle\Navbar;
...
class MenuBuilder extends AbstractNavbarMenuBuilder {
	...
	public function createMainMenu(Request $request){
		...
		$layout = $menu->addChild('Layout', array('route'=>'sidus_layout_example'));
		...
		$examples = $dropdown->addChild('Examples', array('route'=>'sidus_forms_examples'));
		$this->addIcon($examples, array('icon'=>'home'));
		$dropdown->addChild('Horizontal', array('route'=>'sidus_forms_horizontal'));
		$dropdown->addChild('Extended Forms', array('route'=>'sidus_forms_extended'));
		$dropdown->addChild('Extended Views', array('route'=>'sidus_forms_view_extended'));
		$dropdown->addChild('Embedded Type Forms', array('route'=>'sidus_forms_embeddedtype'));
		$dropdown->addChild('Forms Errors', array('route'=>'sidus_forms_errors'));
		$dropdown->addChild('Choice Fields', array('route'=>'sidus_forms_choices'));
		$dropdown->addChild('Collections Fields', array('route'=>'sidus_forms_collections'));
		$menu->addChild('Navbars', array('route'=>'sidus_navbar'));
		$menu->addChild('Macros for components', array('route'=>'sidus_components'));
		// ... add more children
		return $menu;
	}
